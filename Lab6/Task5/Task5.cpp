...
int main()
{
	...
	processes[0] = createProcess(L"C:\\Labs\\Operating_systems\\Lab6\\Lab6\\x64\\Debug\\Task5A.exe").hProcess;
	processes[1] = createProcess(L"C:\\Labs\\Operating_systems\\Lab6\\Lab6\\x64\\Debug\\Task5B.exe").hProcess;
