...
#define FILE_PATH L"C:/Labs/Operating_systems/Lab9/OS_09_01.txt"
...
int main()
{
    ...
    insRowFileTxt(fileName, (LPWSTR)L"4. Rusak Natalya (-1)", -1);
    insRowFileTxt(fileName, (LPWSTR)L"10. Shumskiy Nikita (5)", 5);
